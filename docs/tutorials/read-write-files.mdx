...
To make files available to other workflow components, you should use `/tmp/data` (see [The NaaVRE Interface](../NaaVRE_Interface/#managing-files-in-workflows)).
...
To read and write files in NaaVRE so they remain available after running a workflow, you should use an external storage. The Jupyter
