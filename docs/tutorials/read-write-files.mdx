...
Suitable for: Intermediate files created and used within the same Jupyter notebook cell / workflow component. If you write a file to your current directory (e.g. `/temp.csv`),
it is stored on the local disk of the specific node running that component.
