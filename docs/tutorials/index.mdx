...
Open the NaaVRE demo: https://staging.demo.naavre.net.
...
**Step 1** Open the example notebook in NaaVRE by following [this link](https://staging.demo.naavre.net/vl-openlab/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2FQCDIS%2Flifewatch-notebooks&urlpath=lab%2Ftree%2Flifewatch-notebooks%2FICOS-demo%2Fegu24-icos-naavre.ipynb&branch=main).
