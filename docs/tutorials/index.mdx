...
If you want to understand better why to use a virtual research environment, we recommend reading [the summary of VRE's functionalities](./../about/#notebook-as-a-virtual-research-environment-naavre-platform).
...
See the [Experiment Manager documentation](./../NaaVRE_documentation/experiment-manager/#parallelization) for more information.
:::
...
:::note
If your workflow uses [parameters](../NaaVRE_documentation/creating-workflow-components/#special-variables), you can set their values here. To use values from the notebook, click on 'Use notebook values'.
:::
...
## Summary
You now have a broad overview of workflow creation and workflow running in NaaVRE. To get a better understanding and find out more about other functionalities, you can check the [NaaVRE documentation](./../NaaVRE_documentation/).