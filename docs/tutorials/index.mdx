...
## Summary
You now have a broad overview of workflow creation and workflow running in NaaVRE. To get a better understanding and find out more about other functionalities, you can check out the [NaaVRE documentation](./../NaaVRE_documentation/).