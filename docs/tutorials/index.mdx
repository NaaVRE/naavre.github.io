...
:::note
If your workflow uses [parameters](../NaaVRE_documentation/component-containerizer/#special-variables), you can set their values here. To use values from the notebook, click on 'Use notebook values'.
:::
