...
* Benchmark
  * Perform a benchmark to check the storage and computing needs for the virtual lab: Run the workflow without parallel processing for about an hour to get an estimate of the amount of time needed to process all you need when the workflow is parallelized.
* Parallelization
